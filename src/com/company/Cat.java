...
//            if(age>0 && age<6){
//                cats.get(index).satietyLevel=cats.get(index).satietyLevel+7;
//            }else if (age>6 && age<10) {
//                cats.get(index).satietyLevel=cats.get(index).satietyLevel+5;
//            }else {
//                cats.get(index).satietyLevel=cats.get(index).satietyLevel+4;
//            }
//        }
//
